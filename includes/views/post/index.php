<div class="panel panel-default " xmlns="http://www.w3.org/1999/html">
    <div class="panel-heading">
        ...
        <?php
        if((isset($sessionUser) && $sessionUser !== 3 ) || (strcmp(SESSION::get('id'),$this->post->getPostBy()) === 0) /*|| (strcmp("public/timeline", $_GET['url']) === 0)*/ || (isset($_GET['u']) && (strcmp(SESSION::get('id'), $_GET['u']) === 0))) {
