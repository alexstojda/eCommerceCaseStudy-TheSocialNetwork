            ...
            <div class="form-group">
                <form action="<?= URL ?>wall/post?u=<?= $_GET['u'] ?>" method="post">
                    ...
                    <div class="input-group-btn" align="right">
                        ...
                        <button type="file" class="btn btn-default" aria-haspopup="true" aria-expanded="false"-->
                        <input type="file" class="filestyle" data-classButton="btn btn-primary" data-input="false" data-classIcon="fa fa-camera" data-buttonText="asdf"/>
